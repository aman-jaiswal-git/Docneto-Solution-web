...
<head>
    ...
    <meta name="google-site-verification" content="lYiU1X4NALJD8DDeGvGBSLBqHh73JHR5iyWF5W3bzTU" />
    
    <meta name="title" content="Docneto's Hospital Management Software">
<meta name="description" content="We are a team of healthcare tech innovators focused on transforming hospital operations and patient experiences through smart, user-friendly software. Our core solution simplifies doctor appointment booking, allowing patients to schedule visits remotely—eliminating long waits and unnecessary hospital trips. Specializing in hospital automation, we help medical institutions streamline workflows, reduce administrative burdens, and improve overall efficiency. Designed for reliability and ease of use, our platform bridges the gap between patients and healthcare providers, making quality care more accessible and convenient.">
<meta name="keywords" content="hospital management system, hospital management software, appointment booking, appointment booking software, ">
    ...
    <!-- ################# Header Starts Here#######################--->
      ...
      <header id="menu-jk">
        ...
        <div id="nav-head" class="header-nav">
            <div class="container">
                <div class="row">
                    <div class="col-lg-2 col-md-3 col-sm-12 d-flex align-items-center" style="height: 70px;">
    <img src="assets/images/docnetologo/docnetologo4.gif" alt="Logo" style="height: 60px; width: auto;">
    <a data-toggle="collapse" data-target="#menu" href="#menu" class="ml-2 d-md-none">
        ...
        <div id="carouselExampleIndicators" class="carousel slide" data-ride="carousel">
            ...
            <div class="carousel-inner">
                <div class="carousel-item ">
                    <img class="d-block w-100" src="assets/images/slider/slider_1.png" alt="Second slide">
                ...
                <div class="carousel-item active">
                    <img class="d-block w-100" src="assets/images/slider/slider_4.gif" alt="Third slide">
                ...
                <div class="row no-margin">
                    <div class="col-sm-4 blog-smk">
                        <div class="blog-single">
                                ...
                                <img src="assets/images/patient4.gif" alt="">
                    ...
                    <div class="col-sm-4 blog-smk">
                        <div class="blog-single">
                                ...
                                <img src="assets/images/doctor2.gif" alt="">
                    ...
                    <div class="col-sm-4 blog-smk">
                        <div class="blog-single">
                                ...
                                <img src="assets/images/admin2.gif" alt="">
...
<section class="full-width-image-section">
    <div class="container-fluid px-0">
        <img src="assets/images/teamimg/combineteam2.gif" alt="Descriptive Alt Text" class="img-fluid w-100">
    </div>
</section>
...
?>
    ...
    <div class="copy">
            <div class="container">
        <center>Docneto's Hospital Management System</center> 
