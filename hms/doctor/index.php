...
<body class="login" style=" background: radial-gradient(circle,rgba(238, 174, 202, 1) 0%, rgba(148, 187, 233, 1) 100%);">
    <div class="row">
        <div class="main-login col-xs-10 col-xs-offset-1 col-sm-8 col-sm-offset-2 col-md-4 col-md-offset-4">
            <div class="logo margin-top-30">
                <a href="../../index.php"><h2> Docneto | Doctor Login</h2></a>
            </div>
            <div class="box-login">
                <form class="form-login" method="post">
                    <fieldset>
                        ...
                        <p>
                            ...
                            <span style="color:red;"><?php echo htmlentities($_SESSION['errmsg'] ?? ''); $_SESSION['errmsg'] = ""; ?></span>
                        </p>
                ...
                <div class="copyright">
                    <span class="text-bold text-uppercase">DOCNETO's Hospital Management System</span>
                </div>
            </div>
        </div>
    </div>
